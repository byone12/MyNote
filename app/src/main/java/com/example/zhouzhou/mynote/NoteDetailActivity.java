...
import com.example.zhouzhou.mynote.util.TextFormatUtil;
import com.example.zhouzhou.mynote.widget.LineEditText;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.id_btn_modify) {
            ...
            if (rowID != -1) {
                ...
                getContentResolver().notifyChange(Uri.parse("content://com.example.zhouzhou.mynote.noteprovider/notes"), null);
                finish();
            }
        } else {
            onBackPressed();
