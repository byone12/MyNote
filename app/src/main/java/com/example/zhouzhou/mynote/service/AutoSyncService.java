package com.example.zhouzhou.mynote.service;
...
public class AutoSyncService extends Service{
    ...
    private Uri mUri = Uri.parse("content://com.example.zhouzhou.mynote.noteprovider/notes");
    ...
    public void onCreate() {
        ...
        mTimer.schedule(task, 5000, 2 * 60 * 1000); // 两分钟更新一次
    }
